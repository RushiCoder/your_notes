 ...
 * The functioi dynamically adds a new notebook field element, makes it editable, and listens for
...
const renderExistedNote = function () {
    ...
    const /** {string | underfined} */ activeNotebookId = document.querySelector('[data-notebook].active')?.dataset.notebook;
