...
/**
 * Collectin of functions for performing CRUD(Create, Read, Update, Delete) operations on database.
 * The database state is managed using global variables and local storage.
 * 
 * @namespace
 *@property {Object} get - Fucntioin for retrieving data from the database.
 ...
 @property {Object} delete - Function for delecting data from the database.
*/
export const db = {
