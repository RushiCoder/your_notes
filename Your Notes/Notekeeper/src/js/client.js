 ...
 * 
 * @param {boolean} isThereAnyNotebook - Indicates whether there are any notebook.
*/
...
export const client = {
    ...
    notebook: {
        ...
        */
         ...
         * 
         * @param {Array<Object>} notebookList - list of notebook data ot display.
         */
        read(notebookList) {
         ...
         * @param {string} notebookData - New data for the notebook.
         */
