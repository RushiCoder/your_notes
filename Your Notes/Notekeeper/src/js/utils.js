 ...
 * 
 * @param {Array<HTMLElement>} $elements - to array of DOM elements to attach the event listener to.
 * @param {string} eventType - The type of event to listen for (e.g. 'click' or  'mouseover').
...
/** 
 * Activates a navigation item by adding the 'active' class and deactivaties the prevously active  item.
 */
...
/**
 * Finds a specific note by ites ID within a database of notebooks and their notes.
 * 
